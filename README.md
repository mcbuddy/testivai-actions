> [!WARNING]
> **This repository is superseded and unmaintained.**
>
> TestivAI development moved to **[mcbuddy/testivai-oss](https://github.com/mcbuddy/testivai-oss)** —
> local-first, MIT licensed, and published to npm, PyPI and RubyGems.
>
> Anything below describing a hosted service, dashboard, API key, or upload
> endpoint **no longer applies**. There is no hosted TestivAI service: captures,
> diffs and reports all happen on your machine, with no account and nothing
> uploaded.
>
> Start here instead: **<https://testiv.ai/docs/intro/>**
